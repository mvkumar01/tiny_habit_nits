...
export const metadata: Metadata = {
  title: "Habstick — Healthy habits that fit your life",
  description: "Map your real day and find small food and movement changes easy enough to stick.",
  applicationName: "Habstick",
  openGraph: {
    title: "Habstick — Healthy habits that fit your life",
    description: "Don't rebuild your routine. Improve the one you already have.",
    type: "website",
    images: [{ url: "/og.png", width: 1731, height: 909, alt: "Habstick routine map and tiny habit suggestion" }],
  },
  twitter: {
